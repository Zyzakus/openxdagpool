	...
	<div class="payouts-listing-view">
		<div class="columns is-marginless is-centered">
			<div class="column is-7">
				...
				<hr>
				<p><span class="important">Note:</span> Payouts update approximately every 5 minutes. Times are listed in UTC. Payouts are sent immediately when they are ready.</p>
			</div>
		</div>
	</div>
@endsection
