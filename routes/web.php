...
Route::get('/user/admin/pool-information', 'User\AdministrationController@poolInformation')->name('user.admin.pool-information');
...
// public daemon data
Route::get('/status', 'PublicStatusController@json')->name('status.json');
Route::get('/status/human-readable', 'PublicStatusController@humanReadable')->name('status.humanReadable');
